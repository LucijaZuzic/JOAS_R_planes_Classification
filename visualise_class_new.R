  ...
  if (i != ncol(data_fr)) {
    for (j in (i + 1):ncol(data_fr)) {
      ...
      for (model_name in model_list) {
        ...
        # Saving the plot with all data points

        dev.copy(pdf, new_file_all)

        # Closing the plot with all data points
        ...
        # Saving the plot with training data points

        dev.copy(pdf, new_file_train)

        # Closing the plot with training data points
        ...
        # Saving the plot with testing data points

        dev.copy(pdf, new_file_test)

        # Closing the plot with testing data points
