...
# Storing the minimum and maximum x, y, and z coordinate in meters
...
for (filename_for_traj in filenames_for_trajs) {
  ...
  # Storing the minimum and maximum x, y, and z coordinate
...
rgl.snapshot(file = "all_3D_new.png", fmt = "png")